...
import thomaswinters.gag.template.processor.MultiTemplateValuesProcessor;
import thomaswinters.gag.template.processor.WordTypeTemplateSplitter;
import thomaswinters.gag.valuesgenerator.GagTwogramValuesGenerator;
import thomaswinters.gag.valuesgenerator.NounNounAdjectiveGenerator;
import thomaswinters.gag.valuesgenerator.filter.SameWordsFilter;
import thomaswinters.gag.valuesgenerator.filter.WordTypeTemplateValuesFilter;
import thomaswinters.goofer.generators.EmptyTemplateValuesGenerator;
...
import thomaswinters.goofer.generators.string.DatamuseAdjectiveToNounGenerator;
import thomaswinters.goofer.generators.string.DatamuseNounToNounGenerator;
import thomaswinters.goofer.generators.string.DatamuseRelatedAdjectiveGenerator;
import thomaswinters.goofer.generators.string.IRelatedStringGenerator;
import thomaswinters.goofer.generators.string.TwoGramSQLAdjectiveGenerator;
import thomaswinters.goofer.generators.string.TwoGramSQLNounGenerator;
import thomaswinters.goofer.knowledgebase.SchemaMetrics;
...
import thomaswinters.goofer.metrics.MetricApplicator;
import thomaswinters.goofer.metrics.bi.AdjectiveVectorDifferenceMetric;
import thomaswinters.goofer.metrics.bi.CachedBiMetric;
import thomaswinters.goofer.metrics.bi.TwoGramSQLMetric;
import thomaswinters.goofer.metrics.uni.CachedUniMetric;
import thomaswinters.goofer.metrics.uni.IdentityMetric;
import thomaswinters.goofer.metrics.uni.OneGramSQLMetric;
import thomaswinters.goofer.metrics.uni.OneGramWCMetric;
import thomaswinters.goofer.metrics.uni.RelativeUniMetric;
import thomaswinters.goofer.metrics.uni.WordSensesMetric;
...
import thomaswinters.sentencemarkov.wordcounter.WordCounterIO;
